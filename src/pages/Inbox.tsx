  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : "Could not load your emails";
        toast({
    ...
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Could not assign the email to the case";
      toast({
  ...
  const handleAddEmail = async (newEmail: EmailType, caseId: string) => {
    try {
      ...
      const errorMessage =
        error instanceof Error
          ? error.message
          : "Could not add the email to the case";
      toast({
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-sm text-muted-foreground text-center">
                All emails have been assigned to cases. New unassigned emails
                will appear here.
              </p>
            </CardContent>
          </Card>
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-4">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 pt-3 border-t">
                        ...
                        <Select
                          onValueChange={(value) =>
                            handleAssignToCase(email.id, value)
                          }
